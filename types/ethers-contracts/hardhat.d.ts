...
getContractFactory(name: 'NotebookProof', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.NotebookProof__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'NotebookProof', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.NotebookProof>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'NotebookProof', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.NotebookProof>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'NotebookProof', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.NotebookProof>
