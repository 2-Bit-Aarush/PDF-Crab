...
function parseImageBuffer(buffer) {
    if (buffer.length < 8)
...
function runEvaluation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        globalThis.fetch = (url, init) => __awaiter(this, void 0, void 0, function* () {
